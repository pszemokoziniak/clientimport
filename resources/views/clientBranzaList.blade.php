...
<h1>Branża klient</h1>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <!-- <td>{{$item->id}}</td> -->
                <td><strong>{{$item->branza}}</strong></td>

                <td>
                    <a type="button" class="btn btn-primary w-25" href={{"ClientBranzaEdit/".$item->id}}>Popraw</a>
                    <a type="button" class="btn btn-danger w-25" href={{"ClientBranzaDelete/".$item->id}}>Usuń</a>
                </td>
            </tr>
            @endforeach
        </tbody>
